...
export default function Integrante({ imagem, nome, rm, github, linkedin }: IntegranteProps) {
  return (
    <>
      <div className='flex flex-col items-center px-10 py-5 rounded-lg border-2 border-[#0077c8] shadow-xl gap-1 max-w-96'>
        <div className='bg-[#0077c8] rounded-full aspect-square mb-2'>
          <img src={imagem} alt={`Foto do integrante ${nome}`} />
        </div>
