    ...
    <>
      ...
      <div className='px-16 py-7'>
        <section className='border-b-2 flex flex-col pb-10 gap-2 font-[InterItalic]'>
          ...
          <p className='text-2xl text-[#504F4F] w-[60%]'>
        ...
        <ul className='flex flex-col gap-4 w-[30%]'>
          <li className='bg-[#8FC3E2] flex justify-between items-center p-4 rounded-2xl'>
            <Link to='registro_paciente' className='text-white font-medium text-3xl'>
              Portal do Paciente
            </Link>
            <img src='./Icons/portal_paciente_icon.svg' alt='' />
          </li>
          <li className='bg-[#8FC3E2] flex justify-between items-center p-4 rounded-2xl'>
            <Link to='exames' className='text-white font-medium text-3xl'>
              Resultados dos Exames
            </Link>
            <img src='./Icons/exames_icon.svg' alt='' />
          </li>
          <li className='bg-[#8FC3E2] flex justify-between items-center p-4 rounded-2xl'>
            <Link to='prescricoes' className='text-white font-medium text-3xl'>
              Lista de Prescrições
            </Link>
            <img src='./Icons/prescricoes_icon.svg' alt='' />
          </li>
          <li className='bg-[#8FC3E2] flex justify-between items-center p-4 rounded-2xl'>
            <Link to='agendamentos' className='text-white font-medium text-3xl'>
