        ...
        <article id='etapa-1-registro' className='flex flex-col items-center'>
          ...
          <figure className='flex flex-col items-center mt-4 w-[85%]' id='etapa-imagem-1'>
            ...
            <figcaption className='text-xl font-bold mt-2'>
              ...
              . Através do <span className='text-[#0077c8]'>painel de login</span> do HC, com a <span className='text-[#0077c8]'>etiqueta física</span> de paciente ou com
              o <span className='text-[#0077c8]'>registro no gov.br</span>.
            </figcaption>
          </figure>
        ...
        <article id='etapa-2-registro' className='flex flex-col items-center'>
          ...
          <figure className='flex flex-col items-center mt-4 w-[85%]' id='etapa-imagem-2'>
            ...
            <figcaption className='text-xl font-bold mt-2'>
              ...
              <span className='text-[#0077c8]'>CPF</span> e sua <span className='text-[#0077c8]'>senha</span>, e clicar em <span className='text-[#0077c8]'>acessar</span>
              .
            </figcaption>
          </figure>
